...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    public void setInitialDisplaySize(Display display, int width, int height, int density) {
        ...
        mHasNavigationBar = !mNavBarOverride && Settings.Secure.getIntForUser(
                mContext.getContentResolver(), Settings.Secure.NAVIGATION_BAR_VISIBLE,
	...
	//Here was this, with navbar not visible option: if (mUseGestureButton && !mNavbarVisible && !mGestureButtonRegistered) {
